...
- [https://github.com/reiji990/react-twitter-embed-darkmode](https://github.com/reiji990/react-twitter-embed-darkmode)
...
- [https://github.com/vercel/react-tweet](https://github.com/vercel/react-tweet)

  Vercelが7月に公開した埋め込み用ライブラリ。[既に𝕏からアクセスを拒否されている様子。](https://github.com/vercel/react-tweet/issues/134#issuecomment-1694009353)

### ニコニコ動画

ニコニコ動画公式の埋め込みタグはscriptタグを使用しているが、**Next.jsではscriptタグを使えない。**
...
- [https://github.com/reiji990/blog/blob/main/components/Niconico.tsx](https://github.com/reiji990/blog/blob/main/components/Niconico.tsx)
...
YouTubeは動画ページから埋め込みリンクを取得して貼るだけでも良いが、フルスクリーンにできないことと、幅固定になってしまいスマホで表示した時に表示が崩れる問題がある。
ニコニコ動画埋め込み時のコンポーネントをURLだけ変更してYouTubeに適用する。

- [https://github.com/reiji990/blog/blob/main/components/Youtube.tsx](https://github.com/reiji990/blog/blob/main/components/Youtube.tsx)
...
- 変更箇所
  ...
  - subtitle
    ...
    [https://github.com/reiji990/blog/commit/e880bd5b27626bef73ed27bf3f67e6da57fcdc0c](https://github.com/reiji990/blog/commit/e880bd5b27626bef73ed27bf3f67e6da57fcdc0c)

  - lastmod

    [https://github.com/reiji990/blog/commit/607f33351d80b9490c4c53e0bbe4d4eacfe33a27](https://github.com/reiji990/blog/commit/607f33351d80b9490c4c53e0bbe4d4eacfe33a27)
